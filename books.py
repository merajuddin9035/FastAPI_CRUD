...
BOOKS = [
    Book(1, 'Computer Science Pro', 'codingwithmeraj', 'A very nice book', 5,2013),
    Book(2, 'Be fast with fastapi', 'codingwithmeraj', 'A very great book', 5,2012),
    Book(3, 'Master Endpoints', 'codingwithmeraj', 'A awesome book', 5,2011),
